...
const USER_DEVICES = [
    {
        ...
        manufacturerName: 'Kousic Smart Home',
        toggleString: 'toggle=12:',
        mac : 'A0:20:A6:21:E8:82',
        ...
        friendlyDescription: 'Device1 of Kousic',
    ...
    }, 
     {
        ...
        // Should describe the device type and the company/cloud provider.
        // This value will be shown in the Alexa app
        friendlyDescription: 'Device2 of Kousic',
        // Boolean value to represent the status of the device at time of discovery
        isReachable: true,
        // List the actions the device can support from our API
        // The action should be the name of the actions listed here
    ...
    }, 
     {
        ...
        version: '1.0',
        // The name given by the user in your application. Examples include 'Bedroom light' etc
        friendlyName: 'Device3',
        // Should describe the device type and the company/cloud provider.
        // This value will be shown in the Alexa app
        friendlyDescription: 'Device3 of Kousic',
        // Boolean value to represent the status of the device at time of discovery
        isReachable: true,
        // List the actions the device can support from our API
        // The action should be the name of the actions listed here
    ...
    }, 
     {
        ...
        version: '1.0',
        // The name given by the user in your application. Examples include 'Bedroom light' etc
        friendlyName: 'Device4',
        // Should describe the device type and the company/cloud provider.
        // This value will be shown in the Alexa app
        friendlyDescription: 'Device4 of Kousic',
        // Boolean value to represent the status of the device at time of discovery
        isReachable: true,
        // List the actions the device can support from our API
        // The action should be the name of the actions listed here
    ...
    }, 
     {
        ...
        manufacturerName: 'Kousic Smart Home',
        toggleString: 'toggle=12:',
        mac : 'A0:20:A6:21:E0:47',
        // Model name of the device
        modelName: 'NON-DIMMABLE BULB MODEL ABC',
        // Version number of the product
        version: '1.0',
        // The name given by the user in your application. Examples include 'Bedroom light' etc
        friendlyName: 'Device5',
        // Should describe the device type and the company/cloud provider.
        // This value will be shown in the Alexa app
        friendlyDescription: 'Device5 of Kousic',
        // Boolean value to represent the status of the device at time of discovery
        isReachable: true,
        // List the actions the device can support from our API
        // The action should be the name of the actions listed here
    ...
    }, 
     {
        ...
        version: '1.0',
        // The name given by the user in your application. Examples include 'Bedroom light' etc
        friendlyName: 'Device6',
        // Should describe the device type and the company/cloud provider.
        // This value will be shown in the Alexa app
        friendlyDescription: 'Device6 of Kousic',
        // Boolean value to represent the status of the device at time of discovery
        isReachable: true,
        // List the actions the device can support from our API
        // The action should be the name of the actions listed here
    ...
    }, 
     {
        ...
        version: '1.0',
        // The name given by the user in your application. Examples include 'Bedroom light' etc
        friendlyName: 'Device7',
        // Should describe the device type and the company/cloud provider.
        // This value will be shown in the Alexa app
        friendlyDescription: 'Device7 of Kousic',
        // Boolean value to represent the status of the device at time of discovery
        isReachable: true,
        // List the actions the device can support from our API
        // The action should be the name of the actions listed here
    ...
    }, 
     {
        ...
        version: '1.0',
        // The name given by the user in your application. Examples include 'Bedroom light' etc
        friendlyName: 'Device8',
        // Should describe the device type and the company/cloud provider.
        // This value will be shown in the Alexa app
        friendlyDescription: 'Device8 of Kousic',
        // Boolean value to represent the status of the device at time of discovery
        isReachable: true,
        // List the actions the device can support from our API
        // The action should be the name of the actions listed here
...
function turnOn(applianceId) {
    ...
    log('DEBUG', 'Implement the code to turn on the light');
    const WebSocket = require('ws');
    var message_received = false;
    const ws = new WebSocket('ws://139.59.42.39:3000', {
        'headers': {
            'user-agent': 'Mozilla'
        }
    });
    ws.on('open', function open() {
        console.log('sending');
        var toggleString = "";
        const device = USER_DEVICES.find(device => device.applianceId == applianceId);
        toggleString = device.toggleString + '1';
        var stringToSend = {
            "key": "toggle",
            "mac": device.mac,
            "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmb28iOiJzdW5kZWVwa2F0dGExMTBAZ21haWwuY29tIiwiaWF0IjoxNTMxNDk4NTQ3fQ.kW1sXp9DOAd_9kMZlZJi448XOJiDIG2HxVbfzkA1Orw",
            "user": "sundeepkatta110@gmail.com",
            "value": toggleString
        };
...
function turnOff(applianceId) {
    ...
    log('DEBUG', 'Call the turn off API of Device cloud');
    ...
    ws.on('open', function open() {
        ...
        const device = USER_DEVICES.find(device => device.applianceId == applianceId);
        toggleString = device.toggleString + '0';
        var stringToSend = {
            "key": "toggle",
            "mac": device.mac,
            "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmb28iOiJzdW5kZWVwa2F0dGExMTBAZ21haWwuY29tIiwiaWF0IjoxNTMxNDk4NTQ3fQ.kW1sXp9DOAd_9kMZlZJi448XOJiDIG2HxVbfzkA1Orw",
...
function handleDiscovery(request, callback) {
    ...
    const response = {
        ...
        payload: {
            discoveredAppliances: getDevicesFromPartnerCloud(),
        },
    };
...
function handleControl(request, callback) {
    ...
    switch (request.header.name) {
        case 'TurnOnRequest':
            response = turnOn(applianceId);
            callback(null,generateResponse('TurnOnConfirmation',{}));
            break;

        case 'TurnOffRequest':
            response = turnOff(applianceId);
